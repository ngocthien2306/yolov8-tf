...
def print_model_summary(model, input_size):
    ...
    print("{:<30} {:<20} {:<20}".format("Layer (type)", "Output Shape", "Param #"))
    print("=" * 70)
    ...
    for name, layer in model.named_modules():
        if len(list(layer.children())) == 0:
            ...
            print("{:<30} {:<20} {:<20}".format(name, str(output_shape), num_params))
...
def train(args, params):
    # Model
    model = nn.yolo_v8_tiny(len(params['names'].values())).cuda()
    print_model_summary(model, (128, 128))
    ...
    import glob
    filenames = glob.glob("/root/nguyen/research/YOLOv8-pt/people-detection-evs-1/train/images/*.jpg")
...
def test(args, params, model=None):
    import glob
    filenames = glob.glob("/root/nguyen/research/YOLOv8-pt/people-detection-evs-1/valid/images/*.jpg")
    numpy.random.shuffle(filenames)
